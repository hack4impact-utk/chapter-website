      ...
      <header className={hasScrolledDown ? 'header with_background' : 'header'}>
        <nav className={`container nav_container ${mobileNavOpened ? 'nav_toggled' : ''}`}>
          ...
          <div className="dropdown_link_container">
            ...
            <a href="mailto:utk@hack4impact.org">Contact Us</a>
          </div>
        </nav>
      </header>
      <style jsx>{`
        ...
        .nav_container :global(a + a) {
          margin-left: 10px;
        }

        .nav_container :global(a, a:visited) {
        ...
        .nav_container :global(a:hover, a:visited:hover) {
          color: var(--accent-orange);
        }

        .nav_container .dropdown_link_container {
          display: inherit;
          align-items: inherit;
        }
        ...
        @media (max-width: 1000px) {
          ...
          .nav_container .dropdown_link_container :global(a, a:visited) {
            font-size: 36px;
            font-weight: bold;
            padding: 0;
          }

          .nav_container .dropdown_link_container :global(a + a) {
            margin: 0;
            margin-top: 40px;
          }

          .nav_container.nav_toggled > .dropdown_link_container {
            opacity: 1;
